        ...
        <div class="container container-xl-custom">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto text-end d-flex align-items-center justify-content-end">
                    <a href="tel:+1234567890" class="text-color-light font-weight-bold text-decoration-none d-none d-sm-block me-2">CALL US NOW! <span class="font-weight-light">1-800-123-4567</span></a>
                                ...
                                <div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-4 header-nav-main-sub-effect-1">
                                    <nav>
                                        <ul class="nav nav-pills" id="mainNav">
                                            ...
                                            <li class="dropdown">
                                                <a class="dropdown-item" data-hash data-hash-offset="0" data-hash-offset-lg="95" href="#whoweare">Who We Are</a>
                                            </li>
                                            <li class="dropdown">
                                                <a class="dropdown-item" data-hash data-hash-offset="0" data-hash-offset-lg="95" href="#ourservices">Our Services</a>
                                            </li>
                                            <li class="dropdown">
                                                <a class="dropdown-item" data-hash data-hash-offset="0" data-hash-offset-lg="95" href="#ourprojects">Our Projects</a>
                                            </li>
                                            <li class="dropdown">
                                                <a class="dropdown-item" data-hash data-hash-offset="0" data-hash-offset-lg="95" href="#whyhireus">Why Hire Us</a>
                                            </li>
                                            <li class="dropdown">
                                                <a class="dropdown-item" data-hash data-hash-offset="0" data-hash-offset-lg="95" href="#ourblog">Our Blog</a>
                                            </li>
                                            <li class="dropdown">
                                                <a class="dropdown-item" data-hash data-hash-offset="0" data-hash-offset-lg="95" href="#ourteam">Our Team</a>
                                            </li>
                                            <li class="dropdown">
                                                <a class="dropdown-item" data-hash data-hash-offset="0" data-hash-offset-lg="95" href="#contactus">Contact Us</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
        ...
        <div class="container container-xl-custom">
            ...
            <div id="portfolioLoadMoreBtnWrapper" class="row">
                <div class="col text-center">
                    ...
                    <button id="portfolioLoadMore" class="btn btn-dark btn-outline font-weight-extra-bold text-3 px-5 py-3 border-width-4 appear-animation" data-appear-animation="fadeInUpShorter">LOAD MORE</button><a href="demo-architecture-interior-projects.html" class="btn btn-primary btn-outline ms-2 font-weight-extra-bold text-3 px-5 py-3 border-width-4 appear-animation" data-appear-animation="fadeInUpShorter">VIEW ALL</a>
                </div>
            </div>
                        ...
                        <div>
                            <div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-remove-right-quote custom-testimonial-colored-quotes text-start ps-md-4 mb-0">
                                ...
                                <div class="testimonial-author align-items-start text-start ps-5 ms-3">
                                    <p class="text-start"><strong class="font-weight-extra-bold text-4">- John Smith</strong><span>Okler</span></p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-remove-right-quote custom-testimonial-colored-quotes text-start ps-md-4 mb-0">
                                ...
                                <div class="testimonial-author align-items-start text-start ps-5 ms-3">
                                    <p class="text-start"><strong class="font-weight-extra-bold text-4">- Bob Doe</strong><span>Okler</span></p>
                                </div>
                            </div>
                        </div>
                        <div>
    ...
    <section class="section section-height-4 bg-color-grey-scale-1 border-0 m-0" id="ourblog">
        <div class="container container-xl-custom">
            ...
            <div id="portfolioLoadMoreWrapperBlog" class="row portfolio-list sort-destination pb-2" data-sort-id="portfolio" data-total-pages="3" data-ajax-url="ajax/demo-architecture-interior-blog-ajax-load-more-">
                ...
                <div class="col-lg-4 isotope-item text-start">
            ...
            <div id="portfolioLoadMoreBtnWrapperBlog" class="row">
                <div class="col text-center">
                    ...
                    <a href="demo-architecture-interior-blog.html" class="btn btn-primary btn-outline ms-2 font-weight-extra-bold text-3 px-5 py-3 border-width-4 appear-animation" data-appear-animation="fadeInUpShorter">VIEW ALL</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container container-xl-custom">
        <div class="row justify-content-between">
            ...
            <div class="col-auto text-end">
                <p class="text-color-light font-weight-light opacity-8 mb-0">Copyrights © 2022 All Rights Reserved by Okler</p>
            </div>
        </div>
    </div>
</footer>
